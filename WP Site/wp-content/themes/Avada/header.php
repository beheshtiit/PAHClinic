...
<body <?php body_class( $body_classes ); ?> data-spy="scroll">
	...
	<style type="text/css">
		.popupWrapper{
			background: url("http://pahvirtualclinic.com/wp-content/themes/Avada/images/backPopup.png");
			width: 100%;
			min-height: 1200px;
			position: absolute;
			top: 0;
		...
		.wrapperBox .closePopUp{
			background: url("http://pahvirtualclinic.com/wp-content/themes/Avada/images/closebtn.png");
	...
	<script type="text/javascript" language="javascript">
		...
		jQuery(document).ready(function( $ ){
			var textPopup = "";
			var popupWrapperHeight = 0;
			popupWrapperHeight = popupWrapper = $(document).height();
			$(".popupWrapper").css("height",popupWrapperHeight);

			$(".external-link").click(function(){
				textPopup = "You are now leaving the PAH Virtual Clinic web site and being redirected to www.unitedtherapeutics.eu";
				$(".popupWrapper .mesageText").html(textPopup);
				$(".popupWrapper").fadeIn(500);
				$(".wrapperBox").removeClass("enroll-home-btn");
				$(".wrapperBox").removeClass("enroll-intern-btn");
				$(".wrapperBox .confirm").attr("href", "http://www.unitedtherapeutics.eu");
			});

			$(".first-product-btn").click(function(){
				$(".wrapperBox").css("margin-top", 860 + "px");
				$(".wrapperBox").addClass("indexProductBtn");
			});
			
			$(".enroll-btn").click(function(){
				$(".wrapperBox").css("margin-top", 22 + "%");
				textPopup = "You are now leaving the PAH Virtual Clinic web site and being redirected to the RealCME site";
				$(".popupWrapper .mesageText").html(textPopup);
				$(".popupWrapper").fadeIn(500);
				$(".wrapperBox").removeClass("indexProductBtn");
				$(".wrapperBox .confirm").attr("href", "http://pahvirtualclinic.healthcourse.com/");
				//http://pahclinic.realcme.com/cms/node/155501
			});

			$(".enroll-home").click(function(){
				$(".wrapperBox").css("margin-top", 450 + "px");
				$(".wrapperBox").addClass("enroll-home-btn");
			});

			$(".enroll-intern").click(function(){
				$(".wrapperBox").css("margin-top", 200 + "px");
				$(".wrapperBox").addClass("enroll-intern-btn");
			});

			$(".wrapperBox .cancel, .closePopUp, .confirm").click(function(){
